  ...
  return (
    <section className="relative min-h-screen bg-gradient-to-br from-slate-950 via-blue-950 to-slate-900 text-white overflow-hidden">
      ...
      <AnimatedPopup
        ...
        title="Welcome to CA Ishita & Co"
        message="We provide comprehensive financial advisory and compliance solutions tailored to your business needs. Our expert team is ready to transform your financial landscape."
      />
    </section>
  );
};
